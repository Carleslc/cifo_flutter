...
class Meteo {
  ...
  DateTime get initDateTime {
    // TODO: Use intl DateFormat yyyyMMddHHmmss
    // Converteix al format 20120227T132700
    final initDateWithProperFormat =
        '${init.substring(0, 8)}T${init.substring(8)}0000';
...
class Dataserie {
  ...
  IconData get icon {
    ...
    debugPrint('WeatherIcon not found!!');
